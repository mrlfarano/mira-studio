/**
 * Client-side mirror of server/src/config/types.ts.
 *
 * Keep in sync with the server definitions — these types describe the
 * .mira/ configuration schemas used by the Zustand stores.
 */
